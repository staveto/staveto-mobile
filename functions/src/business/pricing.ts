...
const STRIPE_PRICE_IDS: Record<PlanCode, Record<BillingPeriod, string>> = {
  business_starter: {
    monthly: "price_1TXHexJh7OobdYQQZwNyBHM8",
    yearly: "price_1TXIGJJh7OobdYQQib0xg0pt",
  },
  business_team: {
    monthly: "price_1TXHfkJh7OobdYQQY92bPJfP",
    yearly: "price_1TXIGhJh7OobdYQQvsuuRyG2",
  },
  business_company: {
    monthly: "price_1TXHggJh7OobdYQQob4OzthD",
    yearly: "price_1TXIGyJh7OobdYQQyXYZTKKe",
  },
};
