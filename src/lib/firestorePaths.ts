...
export const paths = {
  ...
  // ─────────────────────────────────────────────────────────────────────────
  // Staveto Business (B2B) — organizations, memberships, customers (rules-gated client CRUD).
  ...
  organizationCustomers: (orgId: string) => `organizations/${orgId}/customers`,
  organizationCustomer: (orgId: string, customerId: string) =>
